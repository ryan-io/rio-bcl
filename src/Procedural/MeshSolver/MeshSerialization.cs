...
namespace Procedural {
	...
	public class MeshSerialization {
		...
		void ProcessCombined(GenerationData generatedData, string filePrefix, bool simplify,
		...
		void ProcessIndividual(GenerationData generatedData, string filePrefix, bool simplify,
			float simplification) {
