...
#region DebugDrawFunctions
		...
		public static void DebugLocalCube(Transform transform, Vector3 size, Color color,
			Vector3 center = default, float duration = 0, bool depthTest = true) {
		...
		///     - Whether or not the circle should be faded when behind other objects.
		/// </param>
		public static void DebugCircle(Vector3 position, float radius = 1.0f, float duration = 0,
			bool depthTest = true) {
		...
		public static void DebugCone(Vector3 position, Vector3 direction, Color color, float angle = 45,
			...
			DebugCircle(position + _forward,                            direction, color,
...
#region GizmoDrawFunctions
		...
		///     - The color of the cube.
		/// </param>
		public static void DrawLocalCube(Matrix4x4 space, Vector3 size, Color color,
			Vector3 center = default) {
			var oldColor = Gizmos.color;
			Gizmos.color = color;
		...
		/// </param>
		/// <param name="is2D">
		///     - Reorients the vector if this is true
		/// </param>
		/// <param name='radius'>
		///     - The radius of the circle.
		/// </param>
		public static void DrawCircle(Vector3 position, Color color, bool is2D, float radius = 1.0f) {
			DrawCircle(position, is2D ? Vector3.forward : Vector3.up, color, radius);
		}
		...
		public static void DrawCone(Vector3 position, Vector3 direction, Color color, float angle = 45) {
			...
			DrawCircle(position + _forward, direction, color,
